...
BLEUnsignedCharCharacteristic batteryLevelChar("2A19",  // standard 16-bit characteristic UUID
    BLERead | BLENotify | BLEWrite);     // remote clients will be able to
...
int delayTime = 500; //default LED flash 0.5 every second
boolean doFlash = false; //default LED should flash, can be changed.
...
//  switchChar.setValue(0);
  ...
  switchCharacteristic.setValue(flashRate);
...
void updateBatteryLevel() {
  /* Read the current voltage level on the A3 analog input pin.
